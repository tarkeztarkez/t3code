...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const piSkillInventory = useProviderSkills({
    environmentId,
    providerInstanceId: selectedProvider === "pi" ? selectedInstanceId : null,
    cwd: gitCwd,
    enabled:
      selectedProvider === "pi" &&
  ...
  const selectedProviderSkills =
    selectedProvider === "pi" ? piSkillInventory.skills : (selectedProviderStatus?.skills ?? []);
  ...
  const isComposerMenuLoading =
    ...
    (composerTriggerKind === "skill" && piSkillInventory.isPending);
