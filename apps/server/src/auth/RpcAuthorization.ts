...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverStartPiCodexLogin]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverCompletePiCodexLogin]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverCancelPiCodexLogin]: AuthOrchestrationOperateScope,
