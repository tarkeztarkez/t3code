...
import { ClaudeModelOptions, CodexModelOptions, CursorModelOptions, PiModelOptions } from "./model";
...
export const ProviderKind = Schema.Literals(["codex", "claudeAgent", "cursor", "pi"]);
