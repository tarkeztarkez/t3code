...
export type PiReasoningOption = (typeof PI_REASONING_OPTIONS)[number];
...
export const PiModelOptions = ClaudeModelOptions;
export type PiModelOptions = ClaudeModelOptions;
